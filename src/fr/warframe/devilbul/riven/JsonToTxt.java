package fr.warframe.devilbul.riven;
...
public class JsonToTxt {
    ...
    private static String adresseSortiePrimary = System.getProperty("user.dir") + File.separator + "resources" + File.separator + "riven" + File.separator + "riven_primary.txt";
    private static String adresseSortieMelee = System.getProperty("user.dir") + File.separator + "resources" + File.separator + "riven" + File.separator + "riven_melee.txt";
    private static String adresseSortieSecondary = System.getProperty("user.dir") + File.separator + "resources" + File.separator + "riven" + File.separator + "riven_secondary.txt";
    private static String adresseSortieShotgun = System.getProperty("user.dir") + File.separator + "resources" + File.separator + "riven" + File.separator + "riven_shotgun.txt";

    public static boolean traitement() {
        return transformeJsonToTxt();
    }

    private static boolean transformeJsonToTxt() {
        try {
            String adresse = new String(Files.readAllBytes(Paths.get("resources" + File.separator + "riven" + File.separator + "riven.json")));
            ...
            JSONArray keys = rivenJson.names(), rivenCategoryJson;
            String key, arme;
            double disposition;
