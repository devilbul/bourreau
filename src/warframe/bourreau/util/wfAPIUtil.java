...
public class wfAPIUtil {
    ...
    private static String DefiDeathMatch(String str) {
        switch (str) {
            // easy
            case "killspaybackeasy":
                return "revenge :\nkill 1 enemies that have killed you";
            case "killsprimaryeasy":
                return "primary target :\nkill 1 enemies with your primary weapon";
            case "matchcompleteeasy":
                return "see it throught :\ncomplete 1 matches";
            ...
            // medium
            case "killsmultimedium":
                return "versatility :\nkill 4 opponents using melee, guns and powers";
    ...
    private static String DefiTeamDeathMatch(String str) {
        switch (str) {
            ...
            // hard
            case "killsprimaryhard":
                return "focused primary target :\nkill 3 enemies with your primary weapon in a match";
            case "killspowerhard":
                return "focused void-painter :\nget 3 power kills in a match";
            case "killswhileinairhard":
                return "focused air strike :\nkill 3 enemies while airbone in a match";
            case "killstargetinairhard":
                return "focused anti-air strike :\nkill 3 airbone enemis in a match";
    ...
    public static String Conditions(String str) {
        ...
        switch (conditions) {
            ...
            case "hazard_fire":
                return "Environmental Hazard : fire";
            case "eximus":
