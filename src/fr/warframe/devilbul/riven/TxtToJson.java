...
public class TxtToJson {
    ...
    private static String adresse = System.getProperty("user.dir") + File.separator + "resources" + File.separator + "riven" + File.separator + origine;
    private static String adresseSortie = System.getProperty("user.dir") + File.separator + "resources" + File.separator + "info" + File.separator + sortie;
